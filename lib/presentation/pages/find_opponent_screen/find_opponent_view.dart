...
import 'package:bulls_n_cows_reloaded/presentation/pages/find_opponent_screen/radar_widget.dart';
                    ...
                    return AnimatedSwitcher(
                      ...
                      child: controller.matrixVisible
                          ...
                          borderRadius: const BorderRadius.all(Radius.circular(
                              45.0)),
                          child: MatrixEffect(controller: Get.put(
                            MatrixEffectController(speedMillis: 60),
                            tag: 'find_opponent',))
                      )
          ...
          StreamBuilder(
              ...
              builder: (context, AsyncSnapshot snapshot) {
                return snapshot.connectionState == ConnectionState.waiting
                  ...
                  children: [
                    Text(
                      (snapshot.data![appGlobalsVersusGamesCountFN] * 2.5)
                          .toStringAsFixed(0) + '_players'.tr,
                      style: statsText,
                    ),
                    const SizedBox(height: 6,),
                    Text(
                      snapshot.data![appGlobalsVersusGamesCountFN].toString() +
                          '_games'.tr,
                      style: statsText,
                    ),
                  ],
